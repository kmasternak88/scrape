...
==================================================================
    _   _                      ____                               
   | \ | | ___  _   _ _   _ ___/ ___|  ___ _ __ __ _ _ __   ___ _ __ 
   |  \| |/ _ \| | | | | | / __\___ \ / __| '__/ _` | '_ \ / _ \ '__|
   | |\  |  __/| |_| | |_| \__ \___) | (__| | | (_| | |_) |  __/ |   
   |_| \_|\___| \__,_|\__,_|___/____/ \___|_|  \__,_| .__/ \___|_|   
                                                    |_|           
...
if [ -f "start_browser_harness.sh" ]; then
    chmod +x start_browser_harness.sh
fi
...
echo "=================================================================="
echo -e ""
echo -e "Your API is installed in: "
echo -e "Python Environment:       Active (Python 3.11+)"
echo -e "Master API Key:           "
echo ""
echo -e "To run Browser-Harness (Chrome CDP inside Xvfb):"
echo -e "   cd  && ./start_browser_harness.sh"
echo ""
echo -e "To run the Scraper API (Manual):"
echo -e "   cd  && .venv/bin/uvicorn nexus.main:app --host  --port "
echo ""
echo -e "To run as a persistent Systemd Service daemon on Linux, execute:"
...
echo -e "[Service]"
echo -e "User="
echo -e "WorkingDirectory="
echo -e "ExecStartPre=/start_browser_harness.sh"
echo -e "ExecStart=/.venv/bin/uvicorn nexus.main:app --host  --port "
echo -e "Restart=always"
echo -e "Environment=PATH=/.venv/bin:/usr/bin:/bin"
echo -e ""
echo -e "[Install]"
...
echo -e "   sudo systemctl enable nexus-scraper.service"
echo -e "   sudo systemctl start nexus-scraper.service"
echo ""
echo "=================================================================="
